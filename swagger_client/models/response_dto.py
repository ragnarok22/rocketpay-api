...
class ResponseDto(object):
    ...
    def __init__(self, success=None):  # noqa: E501
        """ResponseDto - a model defined in Swagger"""  # noqa: E501
        self._success = None
    ...
    @property
    def success(self):
        """Gets the success of this ResponseDto.  # noqa: E501

        indicate if request is successful  # noqa: E501

        :return: The success of this ResponseDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this ResponseDto.

        indicate if request is successful  # noqa: E501

        :param success: The success of this ResponseDto.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDto):
            return False
