...
class FullInvoiceResponseDto(object):
    ...
    def __init__(self, success=None):  # noqa: E501
        """FullInvoiceResponseDto - a model defined in Swagger"""  # noqa: E501
        self._success = None
    ...
    @property
    def success(self):
        """Gets the success of this FullInvoiceResponseDto.  # noqa: E501

        indicate if request is successful  # noqa: E501

        :return: The success of this FullInvoiceResponseDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this FullInvoiceResponseDto.

        indicate if request is successful  # noqa: E501

        :param success: The success of this FullInvoiceResponseDto.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FullInvoiceResponseDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FullInvoiceResponseDto):
            return False
