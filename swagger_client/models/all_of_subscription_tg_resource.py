...
import six
from swagger_client.models.subscription_resource import SubscriptionResource  # noqa: F401,E501

class AllOfSubscriptionTgResource(SubscriptionResource):
    ...
    if hasattr(SubscriptionResource, "swagger_types"):
        swagger_types.update(SubscriptionResource.swagger_types)

    attribute_map = {
    }
    if hasattr(SubscriptionResource, "attribute_map"):
        attribute_map.update(SubscriptionResource.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfSubscriptionTgResource - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        SubscriptionResource.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfSubscriptionTgResource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfSubscriptionTgResource):
            return False
