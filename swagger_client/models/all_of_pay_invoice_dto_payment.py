...
import six
from swagger_client.models.pay_invoice_stat_dto import PayInvoiceStatDto  # noqa: F401,E501

class AllOfPayInvoiceDtoPayment(PayInvoiceStatDto):
    ...
    if hasattr(PayInvoiceStatDto, "swagger_types"):
        swagger_types.update(PayInvoiceStatDto.swagger_types)

    attribute_map = {
    }
    if hasattr(PayInvoiceStatDto, "attribute_map"):
        attribute_map.update(PayInvoiceStatDto.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfPayInvoiceDtoPayment - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        PayInvoiceStatDto.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfPayInvoiceDtoPayment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfPayInvoiceDtoPayment):
            return False
