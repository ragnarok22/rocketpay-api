...
class AvailableCoins(object):
    ...
    def __init__(self, success=None, data=None):  # noqa: E501
        """AvailableCoins - a model defined in Swagger"""  # noqa: E501
        self._success = None
        self._data = None
    ...
    @property
    def success(self):
        """Gets the success of this AvailableCoins.  # noqa: E501

        indicate if request is successful  # noqa: E501

        :return: The success of this AvailableCoins.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this AvailableCoins.

        indicate if request is successful  # noqa: E501

        :param success: The success of this AvailableCoins.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    @property
    def data(self):
        """Gets the data of this AvailableCoins.  # noqa: E501


        :return: The data of this AvailableCoins.  # noqa: E501
        :rtype: AvailableCoinsData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this AvailableCoins.


        :param data: The data of this AvailableCoins.  # noqa: E501
        :type: AvailableCoinsData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AvailableCoins, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AvailableCoins):
            return False
