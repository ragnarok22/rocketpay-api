...
class CheckSubscriptionDto(object):
    ...
    def __init__(self, user_id=None):  # noqa: E501
        """CheckSubscriptionDto - a model defined in Swagger"""  # noqa: E501
        self._user_id = None
    ...
    @property
    def user_id(self):
        """Gets the user_id of this CheckSubscriptionDto.  # noqa: E501

        TG User id  # noqa: E501

        :return: The user_id of this CheckSubscriptionDto.  # noqa: E501
        :rtype: float
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this CheckSubscriptionDto.

        TG User id  # noqa: E501

        :param user_id: The user_id of this CheckSubscriptionDto.  # noqa: E501
        :type: float
        """
        if user_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CheckSubscriptionDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckSubscriptionDto):
            return False
