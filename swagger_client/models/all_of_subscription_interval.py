...
import six
from swagger_client.models.subscription_interval import SubscriptionInterval  # noqa: F401,E501

class AllOfSubscriptionInterval(SubscriptionInterval):
    ...
    if hasattr(SubscriptionInterval, "swagger_types"):
        swagger_types.update(SubscriptionInterval.swagger_types)

    attribute_map = {
    }
    if hasattr(SubscriptionInterval, "attribute_map"):
        attribute_map.update(SubscriptionInterval.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfSubscriptionInterval - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        SubscriptionInterval.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfSubscriptionInterval, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfSubscriptionInterval):
            return False
