...
class DeleteResponseDto(object):
    ...
    def __init__(self, success=None):  # noqa: E501
        """DeleteResponseDto - a model defined in Swagger"""  # noqa: E501
        self._success = None
    ...
    @property
    def success(self):
        """Gets the success of this DeleteResponseDto.  # noqa: E501


        :return: The success of this DeleteResponseDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this DeleteResponseDto.


        :param success: The success of this DeleteResponseDto.  # noqa: E501
        :type: bool
        """
        if success is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteResponseDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteResponseDto):
            return False
