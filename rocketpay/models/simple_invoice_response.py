...
class SimpleInvoiceResponse(ResponseDto):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """SimpleInvoiceResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this SimpleInvoiceResponse.  # noqa: E501


        :return: The data of this SimpleInvoiceResponse.  # noqa: E501
        :rtype: Invoice
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SimpleInvoiceResponse.


        :param data: The data of this SimpleInvoiceResponse.  # noqa: E501
        :type: Invoice
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SimpleInvoiceResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleInvoiceResponse):
            return False
