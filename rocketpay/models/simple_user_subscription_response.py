...
class SimpleUserSubscriptionResponse(ResponseDto):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """SimpleUserSubscriptionResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this SimpleUserSubscriptionResponse.  # noqa: E501


        :return: The data of this SimpleUserSubscriptionResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SimpleUserSubscriptionResponse.


        :param data: The data of this SimpleUserSubscriptionResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SimpleUserSubscriptionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleUserSubscriptionResponse):
            return False
