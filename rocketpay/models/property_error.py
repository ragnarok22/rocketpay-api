...
class PropertyError(object):
    ...
    def __init__(self, _property=None, error=None):  # noqa: E501
        """PropertyError - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def _property(self):
        """Gets the _property of this PropertyError.  # noqa: E501

        name of input field that cannot be processed  # noqa: E501

        :return: The _property of this PropertyError.  # noqa: E501
        :rtype: str
        """
    ...
    def _property(self, _property):
        """Sets the _property of this PropertyError.

        name of input field that cannot be processed  # noqa: E501

        :param _property: The _property of this PropertyError.  # noqa: E501
        :type: str
        """
    ...
    @property
    def error(self):
        """Gets the error of this PropertyError.  # noqa: E501

        text explaining what exactly wrong  # noqa: E501

        :return: The error of this PropertyError.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this PropertyError.

        text explaining what exactly wrong  # noqa: E501

        :param error: The error of this PropertyError.  # noqa: E501
        :type: str
        """
        if error is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PropertyError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PropertyError):
            return False
