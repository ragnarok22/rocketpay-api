...
class SimpleSubscriptionResponse(ResponseDto):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """SimpleSubscriptionResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this SimpleSubscriptionResponse.  # noqa: E501


        :return: The data of this SimpleSubscriptionResponse.  # noqa: E501
        :rtype: Subscription
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SimpleSubscriptionResponse.


        :param data: The data of this SimpleSubscriptionResponse.  # noqa: E501
        :type: Subscription
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SimpleSubscriptionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleSubscriptionResponse):
            return False
