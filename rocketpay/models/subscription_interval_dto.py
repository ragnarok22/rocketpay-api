...
class SubscriptionIntervalDto(object):
    ...
    def __init__(self, interval=None, amount=None, status=None):  # noqa: E501
        """SubscriptionIntervalDto - a model defined in Swagger"""  # noqa: E501
        self._interval = None
        self._amount = None
        self._status = None
    ...
    @property
    def interval(self):
        """Gets the interval of this SubscriptionIntervalDto.  # noqa: E501

        Interval for subscription  # noqa: E501

        :return: The interval of this SubscriptionIntervalDto.  # noqa: E501
        :rtype: str
        """
    ...
    def interval(self, interval):
        """Sets the interval of this SubscriptionIntervalDto.

        Interval for subscription  # noqa: E501

        :param interval: The interval of this SubscriptionIntervalDto.  # noqa: E501
        :type: str
        """
        if interval is None:
    ...
    @property
    def amount(self):
        """Gets the amount of this SubscriptionIntervalDto.  # noqa: E501

        Cost subscription for current interval in currency  # noqa: E501

        :return: The amount of this SubscriptionIntervalDto.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this SubscriptionIntervalDto.

        Cost subscription for current interval in currency  # noqa: E501

        :param amount: The amount of this SubscriptionIntervalDto.  # noqa: E501
        :type: float
        """
        if amount is None:
    ...
    @property
    def status(self):
        """Gets the status of this SubscriptionIntervalDto.  # noqa: E501

        Status for subscription  # noqa: E501

        :return: The status of this SubscriptionIntervalDto.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this SubscriptionIntervalDto.

        Status for subscription  # noqa: E501

        :param status: The status of this SubscriptionIntervalDto.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionIntervalDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionIntervalDto):
            return False
