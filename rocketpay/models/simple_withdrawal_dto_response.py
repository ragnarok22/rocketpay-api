...
class SimpleWithdrawalDtoResponse(ResponseDto):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """SimpleWithdrawalDtoResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this SimpleWithdrawalDtoResponse.  # noqa: E501


        :return: The data of this SimpleWithdrawalDtoResponse.  # noqa: E501
        :rtype: WithdrawalDto
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SimpleWithdrawalDtoResponse.


        :param data: The data of this SimpleWithdrawalDtoResponse.  # noqa: E501
        :type: WithdrawalDto
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SimpleWithdrawalDtoResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleWithdrawalDtoResponse):
            return False
