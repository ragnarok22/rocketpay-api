...
class SimpleShortChequeDtoResponse(ResponseDto):
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        """SimpleShortChequeDtoResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this SimpleShortChequeDtoResponse.  # noqa: E501


        :return: The data of this SimpleShortChequeDtoResponse.  # noqa: E501
        :rtype: ShortChequeDto
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this SimpleShortChequeDtoResponse.


        :param data: The data of this SimpleShortChequeDtoResponse.  # noqa: E501
        :type: ShortChequeDto
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SimpleShortChequeDtoResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleShortChequeDtoResponse):
            return False
