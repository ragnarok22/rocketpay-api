...
import six
from rocketpay.models.set import Set  # noqa: F401,E501

class AllOfShortChequeDtoDisabledLanguages(Set):
    ...
    if hasattr(Set, "swagger_types"):
        swagger_types.update(Set.swagger_types)

    attribute_map = {
    }
    if hasattr(Set, "attribute_map"):
        attribute_map.update(Set.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfShortChequeDtoDisabledLanguages - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfShortChequeDtoDisabledLanguages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfShortChequeDtoDisabledLanguages):
            return False
