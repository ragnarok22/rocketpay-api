...
class WithdrawFeeDto(object):
    ...
    def __init__(self, currency=None, fee=None):  # noqa: E501
        """WithdrawFeeDto - a model defined in Swagger"""  # noqa: E501
        self._currency = None
        self._fee = None
    ...
    @property
    def currency(self):
        """Gets the currency of this WithdrawFeeDto.  # noqa: E501

        ID of main currency for token  # noqa: E501

        :return: The currency of this WithdrawFeeDto.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this WithdrawFeeDto.

        ID of main currency for token  # noqa: E501

        :param currency: The currency of this WithdrawFeeDto.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    @property
    def fee(self):
        """Gets the fee of this WithdrawFeeDto.  # noqa: E501

        Fee amount in main currency  # noqa: E501

        :return: The fee of this WithdrawFeeDto.  # noqa: E501
        :rtype: float
        """
        return self._fee
    ...
    @fee.setter
    def fee(self, fee):
        """Sets the fee of this WithdrawFeeDto.

        Fee amount in main currency  # noqa: E501

        :param fee: The fee of this WithdrawFeeDto.  # noqa: E501
        :type: float
        """
        if fee is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WithdrawFeeDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WithdrawFeeDto):
            return False
