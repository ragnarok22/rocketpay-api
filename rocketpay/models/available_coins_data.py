...
class AvailableCoinsData(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """AvailableCoinsData - a model defined in Swagger"""  # noqa: E501
        self._results = None
    ...
    @property
    def results(self):
        """Gets the results of this AvailableCoinsData.  # noqa: E501


        :return: The results of this AvailableCoinsData.  # noqa: E501
        :rtype: list[CoinDto]
        """
    ...
    def results(self, results):
        """Sets the results of this AvailableCoinsData.


        :param results: The results of this AvailableCoinsData.  # noqa: E501
        :type: list[CoinDto]
        """
        if results is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AvailableCoinsData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AvailableCoinsData):
            return False
