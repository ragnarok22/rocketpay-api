...
class AppApi(object):
    ...
    def get_app_info(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.__get_app_info_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.__get_app_info_with_http_info(**kwargs)  # noqa: E501
            return data

    def __get_app_info_with_http_info(self, **kwargs):  # noqa: E501
        """Returns information about your application  # noqa: E501
    ...
    def transfer(self, body, **kwargs):  # noqa: E501
        """Make transfer of funds to another user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.__transfer_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.__transfer_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def __transfer_with_http_info(self, body, **kwargs):  # noqa: E501
        """Make transfer of funds to another user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.transfer_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError(
                "Missing the required parameter `body` when calling `transfer`")  # noqa: E501
    ...
    def withdrawal(self, body, **kwargs):  # noqa: E501
        """Make withdrawal of funds to external wallet  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.withdrawal(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.__withdrawal_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.__withdrawal_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def __withdrawal_with_http_info(self, body, **kwargs):  # noqa: E501
        """Make withdrawal of funds to external wallet  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.withdrawal_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError(
                "Missing the required parameter `body` when calling `withdrawal`")  # noqa: E501
    ...
    def create_invoice(self, body, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.__create_invoice_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.__create_invoice_with_http_info(body, **kwargs)
            return data

    def __create_invoice_with_http_info(self, body, **kwargs):
        """Create one-time invoice

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP,
        please pass async_req=True
        >>> thread = api.__create_invoice_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            body=body_params,
            post_params=form_params,
            response_type="SimpleInvoiceResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
