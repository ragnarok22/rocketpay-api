...
class VersionApi(object):
    ...
    def version_controller_get_version(self, **kwargs):  # noqa: E501
        """Returns current version of API. You may use it as healthcheck  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.version_controller_get_version(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.version_controller_get_version_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.version_controller_get_version_with_http_info(**kwargs)  # noqa: E501
            return data

    def version_controller_get_version_with_http_info(self, **kwargs):  # noqa: E501
        """Returns current version of API. You may use it as healthcheck  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.version_controller_get_version_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method version_controller_get_version" % key
                )
            params[key] = val
        del params['kwargs']
